#!/bin/bash
#SBATCH --job-name=sweep_diffullama_ff              # Job name
#SBATCH --output="./slurm_logs/sweep_diffullama_ff_%A.out"       # Standard output log
#SBATCH --error="./slurm_logs/sweep_diffullama_ff_%A.err"         # Standard error log
