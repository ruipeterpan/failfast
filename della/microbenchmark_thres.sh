#!/bin/bash
#SBATCH --job-name=microbenchmark_thres              # Job name
...
#SBATCH --time=1:00:00                        # Time limit (24 hours max)
...
SWEEP_lowconf_threshold=(0.05 0.1 0.75 0.8 0.85 0.9 0.95)  # 0.2, 0.25, 0.3, 0.35, 0.4, 0.45
